...
SendLinkSetTrace( integer trace ){
	llMessageLinked( LINK_THIS, CMD_SET_TRACE, (string)trace, NULL_KEY );
}
...
QueueCurrentOnlineRequest(){
    Trace( "QueueCurrentOnlineRequest[ " + (string)CurrentIndex + " ]: " + CurrentString( Names ));
